...
## Características
- Bloqueo granular e independiente de filtros nativos (Cancelación de Eco, Supresión de Ruido y Control Automático de Ganancia).
...
- Control de estado maestro (ON/OFF) e interfaz para excluir sitios específicos (Lista Negra).
- Configuración organizada por pestañas accesibles con soporte completo para lectores de pantalla.

## Instalación

1. Descargá o cloná este repositorio.
2. Ingresá a la sección de extensiones de tu navegador (`chrome://extensions` o `brave://extensions`).
